    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/architecture/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/terminal/**").permitAll()
                // Admin dashboard and cache operations require ADMIN role
                .requestMatchers("/admin/**", "/cache/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST, "/projects/**", "/blogs/**", "/skills/**", "/experiences/**", "/certifications/**", "/profile/**", "/architecture/**", "/terminal/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PUT, "/projects/**", "/blogs/**", "/skills/**", "/experiences/**", "/certifications/**", "/profile/**", "/architecture/**", "/terminal/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/projects/**", "/blogs/**", "/skills/**", "/experiences/**", "/certifications/**", "/profile/**", "/architecture/**", "/terminal/**").hasRole("ADMIN")
