    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/projects/**", "/api/blogs/**", "/api/skills/**", "/api/experiences/**", "/api/certifications/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PUT, "/api/projects/**", "/api/blogs/**", "/api/skills/**", "/api/experiences/**", "/api/certifications/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/projects/**", "/api/blogs/**", "/api/skills/**", "/api/experiences/**", "/api/certifications/**").hasRole("ADMIN")
